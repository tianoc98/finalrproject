...
using FinalProject1.Models.DTOs.Requests;
using FinalProject1.Models.DTOs.Responses;
...
namespace TodoAppWithJWT.Controllers
{
    ...
    public class AuthManagementController : ControllerBase
    {
        ...
        private readonly PaymentContext _apiDbContext;
            ...
            if (ModelState.IsValid)
            {
                ...
                if (isCreated.Succeeded)
                {
                    ...
                    return Ok(new ResponseMessage()
                    {
                        Name = user.Username,
                        Success = true,
                        Message = "User "+user.Username+" Sukses Terdaftar"
                    });
                }
                else
                {
